 ...
 * This file demonstrates how to integrate Polkadotrelay with a web frontend
 */

// For React/Vue/Angular applications
export class PolkadotrelayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PolkadotrelayClient(provider, contractAddress);
