...
const contractABI = require("../artifacts/contracts/Polkadotrelay.sol/Polkadotrelay.json").abi;

program
    .name("polkadotrelay-cli")
    .description("CLI tool for Polkadotrelay smart contract")
    .version("1.0.0");
